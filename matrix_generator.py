...
параметр число от 1 до 100:
    [1-100]
Пример вызова:
    matrix_generator.py 10
Будет сгенерирован файл generated_matrix.csv
В который можно дать на вход программе min_span_tree.py
В нём будет сгенерирована информация о матрице, которая
содержит 10 вершин, между которыми проведены рёбра со случайным
весом
""")
